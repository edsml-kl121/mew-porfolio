  ...
  return (
    <Navbar expand="lg" sticky="top" className="bg-light">
      ...
      {window.innerWidth > 600 ?
          <>
          <Navbar.Brand className="mt-1" style={{fontWeight:"bold"}} href="/"><h4>KANDANAI LEENUTAPHONG</h4></Navbar.Brand> 
          </> : 
          <>
          <Navbar.Brand className="mt-1" style={{fontWeight:"bold"}} href="/"><h5>KANDANAI LEENUTAPHONG</h5></Navbar.Brand>
          </>}
        
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link href="#techstacks" className="">Tech Stack</Nav.Link>
            <Nav.Link href="#projects" className="">Projects</Nav.Link>
          </Nav>
            <NavDropdown title={<span className=" my-auto">Contact</span>} id="basic-nav-dropdown">
